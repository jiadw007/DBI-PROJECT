...
char *dbfile_dir = "/home/sugar/"; // dir where binary heap files should be stored
char *tpch_dir = "/home/DATA/10M/"; // dir where dbgen tpch files (extension *.tbl) can be found
